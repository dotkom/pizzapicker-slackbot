...
fn load_json<T: Deserializable>(include_str: &str) -> Vec<T> {
...
pub fn get_random_pizza<'a>(filter: RouletteFilter) -> &'a PizzaEntry {
...
pub fn get_random_fortune_phrase<'a>() -> &'a FortunePhraseEntry {
